...
abstract class OAuth2Handler
{
    ...
    public function GetAuthorizationUrl(array $credentials, $redirectUri = null, $offline = null, array $params = null)
    {
        ...
        $params = array_merge($params, array('response_type' => 'code', 'client_id' => $credentials['client_id'], 'redirect_uri' => $redirectUri, 'scope' => $this->scope, 'access_type' => $offline ? 'offline' : 'online'));
