...
use SoapFault;
use SoapHeader;
use Google\Api\Ads\AdWords\v201603\AdCustomizerError;
use Google\Api\Ads\AdWords\v201603\AdCustomizerFeedError;
use Google\Api\Ads\AdWords\v201603\AdError;
use Google\Api\Ads\AdWords\v201603\AdGroupAdError;
use Google\Api\Ads\AdWords\v201603\AdGroupCriterionError;
use Google\Api\Ads\AdWords\v201603\AdGroupFeedError;
use Google\Api\Ads\AdWords\v201603\AdGroupServiceError;
use Google\Api\Ads\AdWords\v201603\AdParamError;
use Google\Api\Ads\AdWords\v201603\AdParamPolicyError;
use Google\Api\Ads\AdWords\v201603\AdxError;
use Google\Api\Ads\AdWords\v201603\ApiError;
use Google\Api\Ads\AdWords\v201603\AppPostbackUrlError;
use Google\Api\Ads\AdWords\v201603\AudioError;
use Google\Api\Ads\AdWords\v201603\AuthenticationError;
use Google\Api\Ads\AdWords\v201603\AuthorizationError;
use Google\Api\Ads\AdWords\v201603\BatchJobError;
use Google\Api\Ads\AdWords\v201603\BatchJobProcessingError;
use Google\Api\Ads\AdWords\v201603\BiddingStrategyError;
use Google\Api\Ads\AdWords\v201603\BudgetError;
use Google\Api\Ads\AdWords\v201603\BudgetOrderError;
use Google\Api\Ads\AdWords\v201603\CampaignCriterionError;
use Google\Api\Ads\AdWords\v201603\CampaignError;
use Google\Api\Ads\AdWords\v201603\CampaignFeedError;
use Google\Api\Ads\AdWords\v201603\CampaignPreferenceError;
use Google\Api\Ads\AdWords\v201603\CampaignSharedSetError;
use Google\Api\Ads\AdWords\v201603\ClientTermsError;
use Google\Api\Ads\AdWords\v201603\CollectionSizeError;
use Google\Api\Ads\AdWords\v201603\ConversionTrackingError;
use Google\Api\Ads\AdWords\v201603\CriterionError;
use Google\Api\Ads\AdWords\v201603\CriterionPolicyError;
use Google\Api\Ads\AdWords\v201603\CurrencyCodeError;
use Google\Api\Ads\AdWords\v201603\CustomerError;
use Google\Api\Ads\AdWords\v201603\CustomerFeedError;
use Google\Api\Ads\AdWords\v201603\CustomerOrderLineError;
use Google\Api\Ads\AdWords\v201603\CustomerSyncError;
use Google\Api\Ads\AdWords\v201603\DataError;
use Google\Api\Ads\AdWords\v201603\DatabaseError;
use Google\Api\Ads\AdWords\v201603\DateError;
use Google\Api\Ads\AdWords\v201603\DateRangeError;
use Google\Api\Ads\AdWords\v201603\DistinctError;
use Google\Api\Ads\AdWords\v201603\DraftAsyncError;
use Google\Api\Ads\AdWords\v201603\DraftError;
use Google\Api\Ads\AdWords\v201603\ExperimentError;
use Google\Api\Ads\AdWords\v201603\ExperimentServiceError;
use Google\Api\Ads\AdWords\v201603\ExpressBusinessError;
use Google\Api\Ads\AdWords\v201603\ExtensionSettingError;
use Google\Api\Ads\AdWords\v201603\FeedAttributeReferenceError;
use Google\Api\Ads\AdWords\v201603\FeedError;
use Google\Api\Ads\AdWords\v201603\FeedItemAttributeError;
use Google\Api\Ads\AdWords\v201603\FeedItemError;
use Google\Api\Ads\AdWords\v201603\FeedMappingError;
use Google\Api\Ads\AdWords\v201603\ForwardCompatibilityError;
use Google\Api\Ads\AdWords\v201603\FunctionError;
use Google\Api\Ads\AdWords\v201603\FunctionParsingError;
use Google\Api\Ads\AdWords\v201603\IdError;
use Google\Api\Ads\AdWords\v201603\ImageError;
use Google\Api\Ads\AdWords\v201603\InternalApiError;
use Google\Api\Ads\AdWords\v201603\LabelError;
use Google\Api\Ads\AdWords\v201603\LabelServiceError;
use Google\Api\Ads\AdWords\v201603\LocationCriterionServiceError;
use Google\Api\Ads\AdWords\v201603\ManagedCustomerServiceError;
use Google\Api\Ads\AdWords\v201603\MediaBundleError;
use Google\Api\Ads\AdWords\v201603\MediaError;
use Google\Api\Ads\AdWords\v201603\MultiplierError;
use Google\Api\Ads\AdWords\v201603\MutateMembersError;
use Google\Api\Ads\AdWords\v201603\NewEntityCreationError;
use Google\Api\Ads\AdWords\v201603\NotEmptyError;
use Google\Api\Ads\AdWords\v201603\NotWhitelistedError;
use Google\Api\Ads\AdWords\v201603\NullError;
use Google\Api\Ads\AdWords\v201603\OfflineConversionError;
use Google\Api\Ads\AdWords\v201603\OperatorError;
use Google\Api\Ads\AdWords\v201603\PagingError;
use Google\Api\Ads\AdWords\v201603\PolicyViolationError;
use Google\Api\Ads\AdWords\v201603\PromotionError;
use Google\Api\Ads\AdWords\v201603\QueryError;
use Google\Api\Ads\AdWords\v201603\QuotaCheckError;
use Google\Api\Ads\AdWords\v201603\RangeError;
use Google\Api\Ads\AdWords\v201603\RateExceededError;
use Google\Api\Ads\AdWords\v201603\ReadOnlyError;
use Google\Api\Ads\AdWords\v201603\RegionCodeError;
use Google\Api\Ads\AdWords\v201603\RejectedError;
use Google\Api\Ads\AdWords\v201603\ReportDefinitionError;
use Google\Api\Ads\AdWords\v201603\RequestError;
use Google\Api\Ads\AdWords\v201603\RequiredError;
use Google\Api\Ads\AdWords\v201603\SelectorError;
use Google\Api\Ads\AdWords\v201603\SettingError;
use Google\Api\Ads\AdWords\v201603\SharedCriterionError;
use Google\Api\Ads\AdWords\v201603\SharedSetError;
use Google\Api\Ads\AdWords\v201603\SizeLimitError;
use Google\Api\Ads\AdWords\v201603\StatsQueryError;
use Google\Api\Ads\AdWords\v201603\StringFormatError;
use Google\Api\Ads\AdWords\v201603\StringLengthError;
use Google\Api\Ads\AdWords\v201603\TargetingIdeaError;
use Google\Api\Ads\AdWords\v201603\TrafficEstimatorError;
use Google\Api\Ads\AdWords\v201603\TrialAsyncError;
use Google\Api\Ads\AdWords\v201603\TrialError;
use Google\Api\Ads\AdWords\v201603\UrlError;
use Google\Api\Ads\AdWords\v201603\UserListError;
use Google\Api\Ads\AdWords\v201603\VideoError;
...
_NO_INDENT_721572419', array_map([AdsSoapClient::class, 'implodeHttpHeaders'], array_keys($httpHeaders), $httpHeaders));
...
_NO_INDENT_721572419', trim($this->__getLastRequestHeaders()), XmlUtils::PrettyPrint($this->lastRequest), trim($this->__getLastResponseHeaders()), XmlUtils::PrettyPrint($this->lastResponse));
    ...
    protected function GetTypemaps()
    {
        ...
        $typemaps[] = array(
            ...
            'type_name' => 'long',
            'from_xml'  => [AdsSoapClient::class, 'TypemapLongFromXml'],
            'to_xml'    => [AdsSoapClient::class, 'TypemapLongToXml']
        );
        return $typemaps;
    }
    /**
