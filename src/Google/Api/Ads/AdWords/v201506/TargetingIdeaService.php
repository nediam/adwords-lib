...
class TargetingIdeaService extends AdWordsSoapClient
{
    ...
    public static $classmap = array(
        ...
        'AdFormatSpec'                                    => AdFormatSpec::class,
        'AdFormatSpecListAttribute'                       => AdFormatSpecListAttribute::class,
        'AdSpec'                                          => AdSpec::class,
        'AdSpecListAttribute'                             => AdSpecListAttribute::class,
        ...
        'DisplayAdSpec'                                   => DisplayAdSpec::class,
        'DisplayAdSpec.AdSizeSpec'                        => DisplayAdSpecAdSizeSpec::class,
        'DisplayType'                                     => DisplayType::class,
        'DoubleAttribute'                                 => DoubleAttribute::class,
        'FlashDisplayType'                                => FlashDisplayType::class,
        'HtmlDisplayType'                                 => HtmlDisplayType::class,
        'IdeaTextFilterSearchParameter'                   => IdeaTextFilterSearchParameter::class,
        'IdeaTypeAttribute'                               => IdeaTypeAttribute::class,
        'ImageDisplayType'                                => ImageDisplayType::class,
        'InStreamAdInfo'                                  => InStreamAdInfo::class,
        'InStreamAdInfoAttribute'                         => InStreamAdInfoAttribute::class,
        'InStreamAdSpec'                                  => InStreamAdSpec::class,
        ...
        'PlacementAttribute'                              => PlacementAttribute::class,
        'PlacementTypeAttribute'                          => PlacementTypeAttribute::class,
        'Range'                                           => Range::class,
        ...
        'DisplayAdSpec.ActivationOption'                  => DisplayAdSpecActivationOption::class,
        'HtmlDisplayType.HtmlOption'                      => HtmlDisplayTypeHtmlOption::class,
        'IdeaType'                                        => IdeaType::class,
        'InStreamAdSpec.InStreamType'                     => InStreamAdSpecInStreamType::class,
        'RequestType'                                     => RequestType::class,
        'SiteConstants.AdFormat'                          => SiteConstantsAdFormat::class,
        'SiteConstants.PlacementType'                     => SiteConstantsPlacementType::class,
