...
class TrialAsyncErrorService extends AdWordsSoapClient
{
    ...
    public static $classmap = [
        ...
        'TrialAsyncError' => TrialAsyncError::class,
        'TrialAsyncErrorPage' => TrialAsyncErrorPage::class,
        'Page' => Page::class,
        ...
        'get' => TrialAsyncErrorServiceGet::class,
        'getResponse' => TrialAsyncErrorServiceGetResponse::class,
        'query' => Query::class,
