...
class CampaignService extends AdWordsSoapClient
{
    ...
    public static $classmap = [
        ...
        'VanityPharma' => VanityPharma::class,
        ...
        'CampaignTrialType' => CampaignTrialType::class,
        ...
        'VanityPharmaDisplayUrlMode' => VanityPharmaDisplayUrlMode::class,
        'VanityPharmaText' => VanityPharmaText::class,
